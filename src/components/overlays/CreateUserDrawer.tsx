      ...
      <div className="fixed top-0 right-0 bottom-0 z-50 flex flex-col w-[480px] bg-card text-card-foreground shadow-drawer rounded-l-[16px] motion-safe:animate-drawer-in">
        ...
        {created ? (
          ...
          <div className="flex-1 flex flex-col items-center justify-center px-8 text-center gap-5">
            ...
            <div className="w-full flex items-start gap-3 rounded-lg p-4 bg-info-surface border border-info/30">
              <Mail className="w-4 h-4 mt-0.5 shrink-0 text-info" />
              <p className="text-2sm text-info-foreground leading-relaxed text-left">
